      ...
      <AnimatePresence>
        {open && (
          ...
          >
            {items.map((item, idx) => {
              const content = (
                <div className="h-4 w-4 flex items-center justify-center text-neutral-500 dark:text-neutral-300 [&>svg]:size-full">
                  {item.icon}
                </div>
              );
              return (
  ...
  const containerContent = (
    ...
    >
      ...
      <motion.div
        ...
        className="flex items-center justify-center text-neutral-500 dark:text-neutral-300 [&>svg]:size-full"
      >
        {icon}
      </motion.div>
    </motion.div>
